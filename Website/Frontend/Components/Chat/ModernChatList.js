      ...
      <div className="p-6 border-b border-gray-100">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pl-12 bg-gray-100 border-0 rounded-full text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:bg-white"
          />
            ...
            <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg z-50 max-h-64 overflow-y-auto">
              {searchUsers.map((searchUser) => (
                <button
                  ...
                  className="w-full p-4 flex items-center space-x-3 hover:bg-gray-50 first:rounded-t-xl last:rounded-b-xl transition-colors"
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-6">
            ...
            <p className="text-gray-500 text-sm mb-4">Start a conversation with your friends</p>
            <button
              onClick={() => searchInputRef.current?.focus()}
