...
import ConnectionStatus from '../Features/ConnectionStatus';
import OfflineModeManager from '../Features/OfflineModeManager';
// Fix the import path for MessageBubble
import MessageBubble from '../Messaging/MessageBubble';

// 🚀 Performance & Accessibility Enhancement Imports
import { usePerformanceMonitoring } from '../../../Components/Performance/AdvancedPerformanceOptimizer';
import { useAccessibilityUtils } from '../../../Components/Accessibility/AccessibilityUtils';
import { usePerformanceMonitoring as useDashboardPerformanceMonitoring } from '../../../Components/Performance/PerformanceMonitoringDashboard';
import { useKeyboardShortcuts } from '../../../hooks/useKeyboardShortcuts'; // Add this import
...
const ComprehensiveChatInterface = ({
  ...
  const { registerShortcut, unregisterShortcut } = useKeyboardShortcuts(); // Use the keyboard shortcuts hook
  ...
  useEffect(() => {
    ...
    shortcuts.forEach(shortcut => {
      const keyCombo = shortcut.ctrlKey ? `ctrl+${shortcut.key.toLowerCase()}` : shortcut.key.toLowerCase();
      registerShortcut(keyCombo, shortcut.description, shortcut.description, shortcut.handler);
    });
  ...
  }, [registerShortcut, unregisterShortcut, announce, inputText, selectedMedia.length, messages, user?.profileid]);
  ...
  }, [messages, user?.profileid, announce]);
        ...
        <div className="flex items-center space-x-3">
          <div className="relative">
            <img
              ...
              alt={selectedChat.chatName || selectedChat.name || 'Chat'}
          ...
          <div>
            <h3 className={`font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'
              ...
              {selectedChat.chatName || selectedChat.name || 'Chat'}
            ...
            {selectedChat && (
              <>
                <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold mr-3">
                  {(selectedChat.chatName || selectedChat.name || 'C')?.charAt(0).toUpperCase()}
                </div>
                <div>
                  <h2 className="font-semibold text-gray-800 dark:text-white">{selectedChat.chatName || selectedChat.name || 'Chat'}</h2>
          ...
          <div className={`p-3 rounded-lg ${theme === 'dark' ? 'bg-blue-900/30 border-blue-700' : 'bg-blue-50 border-blue-200'
            ...
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className={`text-sm font-medium ${theme === 'dark' ? 'text-blue-300' : 'text-blue-700'
                ...
                {selectedChat.chatName || selectedChat.name || 'Chat'}'s Note
              </span>
            </div>
          ...
          >
            ...
            <div className="p-6 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h3 className="text-white font-semibold">{selectedChat.chatName || selectedChat.name || 'Chat'}</h3>
              ...
              {callType === 'video' ? (
                <div className="relative w-full h-full">
                  ...
                  <div className="w-full h-full bg-gray-800 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      />
                      <p className="text-white text-xl">{selectedChat.chatName || selectedChat.name || 'Chat'}</p>
                    </div>
                  </div>
                ...
                <div className="w-full h-full bg-gradient-to-b from-gray-800 to-gray-900 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    />
                    <h2 className="text-white text-3xl font-light mb-2">{selectedChat.chatName || selectedChat.name || 'Chat'}</h2>
  ...
  return (
    <div className={`group flex ${isOwn ? 'justify-end' : 'justify-start'} mb-3 px-4`}>
      ...
      >
        ...
        {/* Message info */}
        <div className={`flex items-center justify-end space-x-1 mt-1 ${isOwn ? 'text-white/70' : 'text-gray-500'
          }`}>
