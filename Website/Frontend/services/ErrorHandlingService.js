...
class AppError extends Error {
  ...
  determineSeverity(type) {
    const severityMap = {
      ...
      [ERROR_TYPES.RATE_LIMIT_ERROR]: ERROR_SEVERITY.LOW,
      [ERROR_TYPES.UNAUTHORIZED_ERROR]: ERROR_SEVERITY.HIGH,
      [ERROR_TYPES.FORBIDDEN_ERROR]: ERROR_SEVERITY.HIGH,
      [ERROR_TYPES.NOT_FOUND_ERROR]: ERROR_SEVERITY.LOW,
      [ERROR_TYPES.SERVER_ERROR]: ERROR_SEVERITY.HIGH,
      [ERROR_TYPES.AUTH_TOKEN_EXPIRED]: ERROR_SEVERITY.MEDIUM,
      [ERROR_TYPES.AUTH_INVALID_CREDENTIALS]: ERROR_SEVERITY.HIGH,
      [ERROR_TYPES.AUTH_SESSION_EXPIRED]: ERROR_SEVERITY.MEDIUM,
      [ERROR_TYPES.AUTH_PERMISSION_DENIED]: ERROR_SEVERITY.HIGH,
      [ERROR_TYPES.VALIDATION_ERROR]: ERROR_SEVERITY.LOW,
      [ERROR_TYPES.FORM_VALIDATION_ERROR]: ERROR_SEVERITY.LOW,
      [ERROR_TYPES.FILE_VALIDATION_ERROR]: ERROR_SEVERITY.LOW,
      [ERROR_TYPES.INPUT_FORMAT_ERROR]: ERROR_SEVERITY.LOW,
  ...
  getRecoveryActions(type) {
    const recoveryMap = {
      ...
      [ERROR_TYPES.RATE_LIMIT_ERROR]: [RECOVERY_ACTIONS.RETRY],
      [ERROR_TYPES.UNAUTHORIZED_ERROR]: [RECOVERY_ACTIONS.REFRESH_TOKEN, RECOVERY_ACTIONS.REDIRECT_LOGIN],
      [ERROR_TYPES.FORBIDDEN_ERROR]: [RECOVERY_ACTIONS.USER_ACTION_REQUIRED],
      [ERROR_TYPES.NOT_FOUND_ERROR]: [RECOVERY_ACTIONS.FALLBACK],
      [ERROR_TYPES.SERVER_ERROR]: [RECOVERY_ACTIONS.RETRY, RECOVERY_ACTIONS.FALLBACK],
      [ERROR_TYPES.AUTH_TOKEN_EXPIRED]: [RECOVERY_ACTIONS.REFRESH_TOKEN],
      [ERROR_TYPES.AUTH_INVALID_CREDENTIALS]: [RECOVERY_ACTIONS.REDIRECT_LOGIN],
      [ERROR_TYPES.AUTH_SESSION_EXPIRED]: [RECOVERY_ACTIONS.REDIRECT_LOGIN],
      [ERROR_TYPES.AUTH_PERMISSION_DENIED]: [RECOVERY_ACTIONS.USER_ACTION_REQUIRED],
      [ERROR_TYPES.VALIDATION_ERROR]: [RECOVERY_ACTIONS.USER_ACTION_REQUIRED],
      [ERROR_TYPES.FORM_VALIDATION_ERROR]: [RECOVERY_ACTIONS.USER_ACTION_REQUIRED],
      [ERROR_TYPES.FILE_VALIDATION_ERROR]: [RECOVERY_ACTIONS.USER_ACTION_REQUIRED],
      [ERROR_TYPES.INPUT_FORMAT_ERROR]: [RECOVERY_ACTIONS.USER_ACTION_REQUIRED],
  ...
  generateUserMessage(type, technicalMessage, details) {
    const userMessages = {
      ...
      [ERROR_TYPES.UNAUTHORIZED_ERROR]: 'Please log in to continue.',
      [ERROR_TYPES.FORBIDDEN_ERROR]: 'You don\'t have permission to perform this action.',
      ...
      [ERROR_TYPES.AUTH_SESSION_EXPIRED]: 'Your session has expired. Please log in again.',
      [ERROR_TYPES.AUTH_PERMISSION_DENIED]: 'You don\'t have permission to access this resource.',
      [ERROR_TYPES.VALIDATION_ERROR]: 'Please check your input and try again.',
      [ERROR_TYPES.FORM_VALIDATION_ERROR]: 'Please correct the highlighted fields.',
      [ERROR_TYPES.FILE_VALIDATION_ERROR]: 'Invalid file. Please check file type and size.',
      [ERROR_TYPES.INPUT_FORMAT_ERROR]: 'Invalid input format. Please check your entry.',
...
class ErrorHandlingService extends EventEmitter {
  ...
  convertToAppError(error) {
    ...
    if (error.name === 'TypeError') {
      ...
      // HTTP errors
      if (error.status === 401) type = ERROR_TYPES.UNAUTHORIZED_ERROR;
      else if (error.status === 403) type = ERROR_TYPES.FORBIDDEN_ERROR;
      else if (error.status === 404) type = ERROR_TYPES.NOT_FOUND_ERROR;
  ...
  showNotification(error) {
    ...
    const notificationType = error.severity === ERROR_SEVERITY.CRITICAL ? 'error' :
                           error.severity === ERROR_SEVERITY.HIGH ? 'error' : 'warning';
