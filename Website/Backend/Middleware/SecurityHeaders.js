...
export const corsOptions = {
  ...
  origin: function (origin, callback) {
    ...
    const allowedOrigins = [
      ...
      `http://localhost:${backendPort}`, // Backend self-reference
      'http://127.0.0.1:3000',    // IPv4 localhost alias
      'http://127.0.0.1:3001',    // IPv4 localhost alias
      'http://127.0.0.1:8000',    // IPv4 localhost alias
      `http://127.0.0.1:${backendPort}`, // Backend IPv4 self-reference
      ...
      // Production domains
      'https://swaggo.app',
      'https://www.swaggo.app',
      'https://app.swaggo.app'
    ];
    ...
    if (isDevelopment()) {
      ...
      if (origin.includes('localhost') || origin.includes('127.0.0.1')) {
        ...
        const defaultPorts = ['3000', '3001', '3002', '8000', '8080', '8081', '5173', '4200', '5000', '5001'];
  ...
  exposedHeaders: [
    ...
    'X-Rate-Limit-Reset'
    // SECURITY FIX: Removed 'X-New-Access-Token' to prevent token theft
  ],
