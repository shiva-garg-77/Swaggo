...
import CollaborativeEditingRoutes from './CollaborativeEditingRoutes.js';
...
import SentimentAnalysisRoutes from './SentimentAnalysisRoutes.js';
import SmartCategorizationRoutes from './SmartCategorizationRoutes.js';
...
router.use('/collab', CollaborativeEditingRoutes);
router.use('/keyword', KeywordAlertRoutes);
router.use('/template', MessageTemplateRoutes);
router.use('/poll', PollRoutes);
router.use('/scheduled', ScheduledMessageRoutes);
router.use('/sentiment', SentimentAnalysisRoutes);
router.use('/categorize', SmartCategorizationRoutes);
